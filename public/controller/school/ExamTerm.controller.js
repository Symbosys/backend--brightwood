 ...
 * @access  Private
 */
export const getAllExamTerms = asyncHandler(async (req, res) => {
 ...
 * @access  Private
 */
export const getExamTermById = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * @access  Private/Admin
 */
export const updateExamTerm = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * @access  Private/Admin
 */
export const deleteExamTerm = asyncHandler(async (req, res) => {
    const { id } = req.params;
    const examTerm = await prisma.examTerm.findUnique({ where: { id } });
    if (!examTerm)
        throw new ErrorResponse("Exam term not found", statusCode.Not_Found);
...
//# sourceMappingURL=ExamTerm.controller.js.map
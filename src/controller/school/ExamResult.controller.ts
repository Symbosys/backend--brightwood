 ...
 */
export const markExamResult = asyncHandler(async (req: Request, res: Response) => {
 ...
 * @access  Private/Teacher/Admin
 */
export const markBulkExamResults = asyncHandler(async (req: Request, res: Response) => {
...
export const getExamResults = asyncHandler(async (req: Request, res: Response) => {
    ...
    if (classId || examTermId) {
        whereClause.exam = {};
        if (classId) whereClause.exam.classId = String(classId);
        if (examTermId) whereClause.exam.examTermId = String(examTermId);
    }
...
export const updateResult = asyncHandler(async (req: Request, res: Response) => {
    ...
    if (!existingResult) throw new ErrorResponse("Result not found", statusCode.Not_Found);

 ...
 * @access Private/Admin
 */
export const getAllFeePayments = asyncHandler(async (req: Request, res: Response) => {
 ...
 * @access Private/Admin
 */
export const getFeePaymentById = asyncHandler(async (req: Request, res: Response) => {
    const { id } = req.params;
 ...
 * @access Private/Admin
 */
export const deleteFeePayment = asyncHandler(async (req: Request, res: Response) => {
    const { id } = req.params;
